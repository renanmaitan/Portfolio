export const skills = [
  {
    name: 'Electron',
    src: 'assets/imgs/skills/electron-icon.png',
    redirect: true,
  ...
  {
    name: 'Angular',
    src: 'assets/imgs/skills/angular-icon.png',
    redirect: true,
...
export const languages = [
  {
    name: 'JavaScript',
    src: 'assets/imgs/skills/js-icon.png',
    redirect: false,
  },
  {
    name: 'Python',
    src: 'assets/imgs/skills/python-icon.png',
    redirect: false,
  },
  {
    name: 'Typescript',
    src: 'assets/imgs/skills/typescript-icon.png',
    redirect: false,
  },
